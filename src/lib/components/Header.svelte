...
<header class="navbar bg-base-100 shadow-lg">
  <div class="navbar-start">
    <a href="/" class="btn btn-ghost text-xl">
      <span class="font-bold text-primary">Matter</span>Mind
    </a>
  </div>
  <div class="navbar-center hidden lg:flex">
    <div class="flex items-center space-x-4">
      <div class="stat bg-transparent">
        ...
        <div class="stat-value text-secondary">{$physicsStore.objectCount}</div>
      </div>
      <div class="stat bg-transparent">
        <div class="stat-title">FPS</div>
        <div class="stat-value text-secondary">{$physicsStore.fps}</div>
      </div>
    </div>
  </div>
